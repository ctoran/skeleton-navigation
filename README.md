...
This skeleton is part of the [Aurelia](http://www.aurelia.io/) platform. It sets up a standard navigation-style app using gulp to build your ES6 code with the Babel compiler. If you want to use TypeScript, look in the `master-typescript` branch for an equivalent TypeScript version of this app. Karma/Protractor/Jasmine testing is also configured.
